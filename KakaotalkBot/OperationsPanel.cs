...
namespace KakaotalkBot
{
    public partial class Form1
    {
        ...
        private void TickOperations()
        {
            ...
            {
                operationsSearch.Text = bot.RequestedHistoryUserId.ToString(); RefreshOperationsUsers();
                if (operationsUsers.Items.Count > 0) operationsUsers.SelectedIndex = 0;
                tabControl1.SelectedTab = operationsPage; operationsViews.SelectedIndex = 0; bot.RequestedHistoryUserId = 0;
            }
        }
    }
}
