...
namespace KakaotalkBot
{
    public class GoogleSheetHelper
    {
        ...
        internal void WriteUserData(List<List<object>> users, UserActivityStore activity, RoomOperatorStore operators = null, OperationsStore operations = null)
        {
            lock (lockObject)
            {
        ...
        internal void EnsureActivitySchema()
        {
            lock (lockObject)
            {
                ...
                var definitions = new Dictionary<string, string[]> { { "DB_RoomUsers", UserActivityStore.RoomHeaders },
                    ...
                    { "DB_RoomOperators", RoomOperatorStore.Headers }, { "DB_Operations", OperationsStore.Headers } };
        ...
        internal List<List<string>> ReadActivityTable(string title, string[] headers)
        {
            ...
            foreach (var row in values.Skip(1))
            {
                ...
                foreach (int column in title == "DB_Operations" ? new int[0] : idColumns)
